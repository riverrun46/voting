...
const contract_id = {
  ...
  txId: '56b1b04903ea77895f94787c0348b61a59e48ea3e94ceb9fac59358eaa200c03',
  /** The output index */
  outputIndex: 0,
}
...
function App() {
  ...
  async function fetchContract() {
    try {
      const instance = await Scrypt.contractApi.getLatestInstance(Voting, contract_id)
  ...
  return (
    <div className="App">
      ...
      <TableContainer component={Paper} variant="outlined" style={{ width: 1200, height: '80vh', margin: 'auto' }}>
        <Table>
          <TableHead>
            <TableRow>
          ...
          <TableBody>
              ...
              <TableCell align="center">
                <Box>
                  <Box
                    ...
                    component="img"
                    alt={'window'}
                    src={`${process.env.PUBLIC_URL}/${'window'}.jpg`}
                  />
                </Box>
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell align="center">
                <Box>
                  <Typography variant={'h1'}>{votingContract?.candidates[0].votesReceived.toString()}</Typography>
                  <Button variant="text" onClick={voting} name={votingContract?.candidates[0].name}>
                    👍
                  </Button>
                </Box>
              </TableCell>
              ...
              <TableCell align="center">
                ...
                <Box>
                  <Typography variant={'h1'}>{votingContract?.candidates[1].votesReceived.toString()}</Typography>
                  <Button variant="text" onClick={voting} name={votingContract?.candidates[1].name}>
                    👍
                  </Button>
                </Box>
              </TableCell>
              <TableCell align="center">
                <Divider orientation="vertical" flexItem />
                <Box>
                  <Typography variant={'h1'}>{votingContract?.candidates[2].votesReceived.toString()}</Typography>
                  <Button variant="text" onClick={voting} name={votingContract?.candidates[2].name}>
                    👍
                  </Button>
                </Box>
              </TableCell>
